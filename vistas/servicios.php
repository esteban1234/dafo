...
<body>
    ...
    <nav class="pull-right">
        <ul>
            ...
            <a class="select" id="selector" href="servicios.php">SERVICIOS</a>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <img src="../img/da.jpg"
            class="img-responsive">
            <h3 class="text-center">DERECHO MERCANTIL Y CORREDURÍA PÚBLICA</h3>
            <p class="">Respecto a cualquier requerimiento que pudiera presentarse a cualquier inversionista, empresa o comerciante, abarcando desde la constitución de nuevas empresas, todas las necesidades que llegaren a presentarse durante su operación, hasta su liquidación.</p>
          </div>
          <div class="col-md-3">
            <img src="../img/da.jpg"
